...
public void createCustomerProfileTable() throws Exception{
		...
		try {
			...
			Table table =dynamoDbConfig.getDynamoDB().createTable(AppConstant.CUSTPROFILE,
					...
					Arrays.asList(	//mandatory fields
						new AttributeDefinition("id", ScalarAttributeType.S), 
						new AttributeDefinition("name", ScalarAttributeType.S),
						new AttributeDefinition("specialty", ScalarAttributeType.S),
						new AttributeDefinition("membershipStatus", ScalarAttributeType.S)
...
public Table getTable(String custprofile) {
