 ...
 * (/Users/asimahameedi/.aws/credentials) where the sample code will load the credentials from.
 * <p>
...
public class CloudFormationSample {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * (/Users/asimahameedi/.aws/credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/asimahameedi/.aws/credentials), and is in valid format.",
                    e);
        }
